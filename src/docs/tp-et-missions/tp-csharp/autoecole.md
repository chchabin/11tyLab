...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleUseCase.png" "autoecoleUseCase" "50%" "50%" %}
...
```mermaid
graph TD
    A[Présentation] --> B[Couche d'Accès aux données Entity Framework]
...
4. Chargez le fichier sql avec `File>Open>File` ou `CTRL + O` et Exécutez le
   {% figure-abs "images/exercices-et-challenges/sqlserverexecut01.png" "sqlserverexecut01" "50%" "50%" %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleADO.png" "autoecoleADO" "50%" "50%" %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleConnexion.png" "autoecoleConnexion" "50%" "50%" %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLocalhost.png" "autoecoleLocalhost" "50%" "50%" %}
{% callout %}
...
3. Faire terminer.  
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleTables.png" "autoecoleTables" "50%" "50%" %}
Entity Framework génère un modèle objet qui sera chargé en mémoire :
{% figure-abs "images/exercices-et-challenges/cas/autoecoleModele.png" "autoecoleModele" "50%" "50%" %}
...
{% endcallout %}
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleMenu.png" "autoecoleMenu" "50%" "50%" %}
   {% callout %}
...
{% endcallout %}
   ...
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleEdmx.png" "autoecoleEdmx" "50%" "50%" %}
   C’est cette classe
   qui assure la liaison à la base, gère le mapping avec le modèle relationnel, sauvegarde les données en
   base.
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleContexte.png" "autoecoleContexte" "50%" "50%" %}
...
Pour que les formulaires s'intègrent dans le MDI, il faut copier le code de cette façon :
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleMDI.png" "autoecoleMDI" "50%" "50%" %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleGerer.png" "autoecoleGerer" "50%" "50%" %}
...
{% endcallout %}
  {% figure-abs "images/exercices-et-challenges/cas/autoecoleCombobox.png" "autoecoleCombobox" "50%" "50%" %}
  {% callout %}
- Nous allons ensuite lier l’ouverture de ce formulaire au formulaire de menu :
  {% endcallout %}
  {% figure-abs "images/exercices-et-challenges/cas/autoecoleLienEleve.png" "autoecoleLienEleve" "50%" "50%" %}
  {% callout %}
- Dans le formulaire FrmMenu :
  {% endcallout %}
  {% figure-abs "images/exercices-et-challenges/cas/autoecoleAppel.png" "autoecoleAppel" "60%" "60%"  %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleBinding.png" "autoecoleBinding" "100%" "100%" %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleBoiteBdg.png" "autoecoleBoiteBdg" "50%" "50%"  %}
{% callout %}
...
- Indiquer que la source est un objet.
  {% endcallout %}
  {% figure-abs "images/exercices-et-challenges/cas/autoecoleObjetBdg.png" "autoecoleObjetBdg" "50%" "50%"  %}
  {% callout %}
Sélectionner la classe eleve.
  {% endcallout %}
  {% figure-abs "images/exercices-et-challenges/cas/autoecoleChxBdg.png" "autoecoleChxBdg" "50%" "50%"  %}
  {% callout danger %}
- Si la source n'apparait pas, compilez le projet.
{% endcallout %} 
  Le composant de binding connait maintenant sa source de données :
  {% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgProp.png" "autoecoleBdgProp" "50%" "50%"  %}
  {% callout warning %}
...
**il n’y a pas encore de chargement des données venant de la classe de contexte de donnée**.
  ...
  {% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgCode.png" "autoecoleBdgGode" "50%" "50%" %}
  ...
  {% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgTxt.png" "autoecoleTxt" "50%" "50%"  %}
  {% callout %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgFrm.png" "autoecoleFrm" "50%" "50%"  %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgNavBox.png" "autoecoleNavBox" "50%" "50%"  %}
{% callout %}
- Modifiez son nom en `bdgNav`
- Paramétrons ce composant dans sa propriété `BindingSource`
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgNav.png" "autoecoleNav" "30%" "30%"  %}
...
- Écrire la méthode `getNumEleve` dans la classe `FrmGererEleve`.
  {% endcallout %}
  {% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgNavCode.png" "autoecoleBdgNavCode" "70%" "70%"  %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgNavItem.png" "autoecoleBdgNavItem" "50%" "50%"  %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgNavObjet.png" "autoecoleBdgNavObjet" "50%" "50%"  %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleBdgNavBtn.png" "autoecoleBdgNavBtn" "70%" "70%" %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleNavDelete.png" "autoecoleNavDelete" "50%" "50%"  %}
En suite, il faut relier la modification à la base de données :
{% figure-abs "images/exercices-et-challenges/cas/autoecoleNavCodeDelete.png" "autoecoleNavCodeDelete" "70%" "70%" %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleVehiculeGerer.png" "autoecoleVéhiculeGérer" "50%" "50%"  %}
...
2. Il faut « intercepter » l’événement lorsque le bouton est « déchécké », événement qui a lieu
avant l’événement click. C’est l’événement `checkedChanged`.
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleChkChg.png" "autoecoleChkChg" "80%" "80%" %}
...
Voici la maquette attendue :
{% figure-abs "images/exercices-et-challenges/cas/autoecoleVehiculeListe.png" "autoecoleVéhiculeListe" "50%" "50%"  %}
{% callout %}
...
{% endcallout %}
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleVehiculeBdg.png" "autoecoleVéhiculeBdg" "50%" "50%"  %}
   {% callout %}
7. Déposez dans le formulaire un DataGridView, 
8. renommez-le `dgvVehicule`, 
9. valorisons sa propriété DataSource :
   {% endcallout %}
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleVehiculeDgrd.png" "autoecoleVéhiculeDgrd" "50%" "50%"  %}
   {% callout %}
10. Sur un clic droit, sur le DataGridView, modifiez les colonnes pour rendre les 3 premières en
   readOnly :
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleVehiculeDgrdM.png" "autoecoleVéhiculeDgrdM" "50%" "50%"  %}
{% callout %}
11. Ajoutez le chargement des données dans la construction :
{% endcallout %}
    {% figure-abs "images/exercices-et-challenges/cas/autoecoleVehiculeCharge.png" "autoecoleVéhiculeCharge" "50%" "50%"  %}
    {% callout %}
12. Enfin, ajoutez un bouton dans le formulaire pour enregistrer les modifications :
    {% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleVehiculeBtn.png" "autoecoleVéhiculeBtn" "50%" "50%"  %}

### f) Le formulaire d’ajout d’une leçon
Voici la maquette attendue :
{% figure-abs "images/exercices-et-challenges/cas/autoecoleAjouterLecon.png" "autoecoleAjouterLecon" "50%" "50%"  %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleAjouterLeconBdg.png" "autoecoleAjouterLeconBdg" "50%" "50%"  %}
   {% callout %}
4. Liez le comboBox `cmbEleve` à cette source :
   {% endcallout %}
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleAjouterLeconCmb.png" "autoecoleAjouterLeconCmb" "40%" "40%"  %}
   {% callout %}
5. Remplissez la source de données et chargeons `cmbHeure` avec des données correspondant à des horaires
   {% endcallout %}
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleAjouterLeconData.png" "autoecoleAjouterLeconData" "50%" "50%"  %}
...
{% endcallout %}
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleAjouterLeconNew.png" "autoecoleAjouterLeconNew" "50%" "50%"  %}
   {% callout %}
...
8. Enregistrez la nouvelle leçon par l’appel du clic sur le bouton enregistrer
   {% endcallout %}
   {% figure-abs "images/exercices-et-challenges/cas/autoecoleAjouterLeconBtn.png" "autoecoleAjouterLeconBtn" "90%" "90%"  %}
...
Voici la maquette attendue :
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconValider.png" "autoecoleLeconValider" "50%" "50%"  %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconValiderDgrd.png" "autoecoleLeconValiderDgrd" "50%" "50%"  %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconValider2.png" "autoecoleLeconValider2" "50%" "50%"  %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconValider2Dgrd.png" "autoecoleLeconValider2Dgrd." "90%" "90%"  %}
Pour le bouton, nous avons :
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconValider2Btn.png" "autoecoleLeconValider2Btn" "70%" "70%"  %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconListe.png" "autoecoleLeconListe" "50%" "50%"  %}
{% callout %}
Déposez 3 sources de données :
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconListeBdg.png" "autoecoleLeconListeBdg" "50%" "50%"  %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconListeCol.png" "autoecoleLeconListeCol" "50%" "50%"  %}
{% callout %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconListeCol2.png" "autoecoleLeconListeCol2" "50%" "50%"  %}
{% callout %}
Renseignez la propriété de binding du DataGridView ainsi :
{% endcallout %}
On va chercher la propriété avancée du DataBinding :
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconListeDtg.png" "autoecoleLeconListeDtg" "50%" "50%"  %}
{% callout %}
Dans la fenêtre proposée indiquez la DataSource ; ici ce sont les leçons de chaque élève :
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconListeCol3.png" "autoecoleLeconListeCol3" "50%" "50%"  %}
Ce qui va produire :
{% figure-abs "images/exercices-et-challenges/cas/autoecoleLeconListeDtg2.png" "autoecoleLeconListeDtg2" "50%" "50%"  %}
{% callout %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecolePSExec.png" "autoecolePSExec" "50%" "50%"  %}
...
{% figure-abs "images/exercices-et-challenges/cas/autoecolePSEf.png" "autoecolePSEf" "50%" "50%"  %}
...
{% endcallout %}
{% figure-abs "images/exercices-et-challenges/cas/autoecolePSEf2.png" "autoecolePSEf2" "50%" "50%"  %}
Dans l’explorateur de modèle :
{% figure-abs "images/exercices-et-challenges/cas/autoecolePSEf3.png" "autoecolePSEf3" "50%" "50%"  %}
Vous allez importer une nouvelle fonction :
{% figure-abs "images/exercices-et-challenges/cas/autoecolePSEf4.png" "autoecolePSEf4" "50%" "50%"  %}
