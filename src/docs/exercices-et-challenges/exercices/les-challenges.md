...
Il s'agit d'afficher des distributions de notes. Les notes sont générées par une fonction aléatoire donnée au point `b`. Écrire le programme à partir des fonctions suivantes :
...
### c - Affichage de la distribution des notes
...
stat[2] contiendra le nombre de notes <12 
stat[3] contiendra le nombre de notes <16
stat[4] contiendra le nombre de notes <20 
```
